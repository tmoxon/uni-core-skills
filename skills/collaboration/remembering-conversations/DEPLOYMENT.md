...
ls -lt ~/.config/uni/conversation-archive/*/*.jsonl | head -5

# Check database size
ls -lh ~/.config/uni/conversation-index/db.sqlite
...
sqlite3 ~/.config/uni/conversation-index/db.sqlite "SELECT COUNT(*) FROM exchanges;"
...
cp ~/.config/uni/conversation-index/db.sqlite ~/.config/uni/conversation-index/db.sqlite.backup
